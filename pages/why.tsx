        ...
        <div className="w-full md:w-4/5 flex flex-col m-6">
            <div className="my-2 py-2 border-b border-b-amber-300">
                <h1 className="text-2xl md:text-6xl">
                    <strong>Pourquoi lancer ton <span className="text-orange-600"><em>Micro SaaS</em></span> ?</strong>
                </h1>
            ...
            <section className="flex flex-col justify-start my-6text-left text-justify">
                <div className="my-2 py-2 border-b border-b-amber-300">
                    <h2 className="font-bold">Si tu es comme moi, ou plus ou moins comme moi, tu dois ressentir le besoin de créer quelque chose par toi-même, qui a du sens et qui t'anime.</h2>
                    <ul className="my-1">
                        <li>&#183; peut-être que tu t'ennuies dans ton job actuel ou que tu attends avec impatience la fin de ta mission ?</li>
                        <li>&#183; peut-être que tu as fait le tour de ce que tu pouvais apprendre ?</li>
                        <li>&#183; peut-être que tu as atteint un certain plafond de verre avec tes revenus issus de la vente de temps ?</li>
                    </ul>
                    ...
                    <div className="my-2">
                        ...
                        <ul className="my-1">
                            ...
                            <li>&#183; tant que tu vends ton temps, que ce soit en tant que salarié ou freelance, tes revenus seront limités !</li>
                        </ul>
                    </div>
                </div>
                <div className="my-2 py-2 border-b border-b-amber-300">
                    <h2 className="font-bold">Tu es capable de coder, tu as un avantage sur 95% de la population pour lancer ton produit.</h2>
                ...
                <div className="my-2 py-2 border-b border-b-amber-300">
                    <h2 className="font-bold">Lancer son MicroSaaS présente peu de risques, peu de frais, une charge de travail modérée (quand on s'y prend bien) et des bénéfices importants.</h2>
