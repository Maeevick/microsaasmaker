...
const Home: NextPage = () => {
    return (
        <>
            <h1 className="m-6 text-2xl md:text-6xl">
                <strong>
                    Libère-toi du travail en lançant ton{' '}
            ...
            <section className="flex flex-col items-center md:flex-row">
                ...
                <div className="flex flex-col md:justify-center md:ml-10">
                    <BulletPoint
                        content="Pourquoi coder 8 heures par jour pendant 40 ans pour quelqu'un d'autre ?"
                        img="/why.png"
                    />
                    <BulletPoint
                        content="Pourquoi galérer dans un job / environnement qui ne te convient pas ?"
                        img="/why.png"
                    />
                    <BulletPoint
                        content="Pourquoi rêver d'avoir de l'impact dans un domaine et attendre ?"
                        img="/why.png"
                    />
                    <BulletPoint
                        content="Aujourd'hui lancer un produit en solo est accessible à tout dev !"
                        img="/gear.png"
                        isBold={true}
                    />
            ...
            <section className="flex flex-col items-center border-t-orange-600 border-t-2 mt-10 pt-4">
                <h2 className="font-bold mb-3 text-xl md:text-2xl">
                    Quel intérêt de t'abonner à une énième newsletter ?
                </h2>
                ...
                <div className="flex flex-col md:flex-row mt-3">
                    <Tile>
                        ...
                        <ul className="text-left">
                            <li className="mt-1 mb-2">
                                &#183; Affiner le besoin et le problème auquel répond ton produit.
                            </li>
                            ...
                            <li className="mt-1 mb-2">
                                &#183; Évaluer tes bénéfices et la viabilité économique de ton produit.
                            </li>
                        </ul>
                    </Tile>
                    <Tile>
                        ...
                        <ul className="text-left">
                            <li className="mt-1 mb-2">
                                &#183; Faire le grand saut et interviewer tes utilisateurs&#183;trices.
                            </li>
                    ...
                    <Tile>
                        ...
                        <ul className="text-left">
                            ...
                            <li className="mt-1 mb-2">
                                &#183; Mettre en place des bases techniques saines et solides.
                            </li>
                            <li className="mt-1 mb-2">&#183; Développer et itérer à la vitesse de l'éclair.</li>
                            <li className="mt-1 mb-2">
                                &#183; Mesurer et ajuster sans douleur et (presque) sans effort.
                            </li>
                        </ul>
                    </Tile>
                    <Tile>
